...
/// <param name="Source">The type/category of the error for classification and handling purposes (see <see cref="FailureSource"/>).</param>
public record Error(Exception? Exception, FailureSource Source);